  ...
  return (
    <div style={{
      ...
      <div className="flex flex-col md:flex-row lg:gap-40">
        ...
        <div className="h-[300px] lg:h-[300px] lg:w-[400px] w-[350px] border-2 rounded-3xl border-[#abb8c0] text-center justify-center items-center flex flex-col m-2 p-5 mb-7">

          <div className="bg-[#abb8c0] mt-[-80px] lg:mt-[-90px]  rounded-full border-2 border-[#abb8c0] max-w-20 max-h-20 ">
        ...
        <div className="h-[300px] lg:h-[300px] lg:w-[400px] w-[350px] border-2 rounded-3xl border-[#abb8c0] text-center justify-center items-center flex flex-col m-2 p-5">
          <div className="bg-[#abb8c0] mt-[-80px] rounded-full border-2 border-[#abb8c0] max-w-20 max-h-20 lg:mt-[-90px] ">
